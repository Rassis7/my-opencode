...
## Related Skills
- [Terraform code generation](../terraform-style-guide/SKILL.md) - Style guide for the new Terraform Module
- [Azure Verified Modules](../azure-verified-modules/SKILL.md) - Recommended module specifications for Azure
